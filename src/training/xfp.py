...
import pyspiel
from open_spiel.python.algorithms import fictitious_play, exploitability
import time
...
flags.DEFINE_enum("training_agent", "XFPSolver", VALID_PLAYERS, "Name of Agent to train")
